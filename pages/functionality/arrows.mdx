...
# Arrows
Arrows allow you to navigate between the slides. Arrows are included on both Slider and Carousel Types. They allow a very smooth switch experience for the users. You can disable this option if you don't want to have them.
